  ...
  return (
    <main className="min-h-screen bg-background pt-24 text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-6xl font-display font-bold tracking-tighter">{pageTitle}</h1>
          <p className="text-[10px] uppercase tracking-[0.4em] font-bold opacity-50">{pageSubtitle}</p>
        </div>
