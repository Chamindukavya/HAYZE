  ...
  ({ title, subtitle, images, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'relative w-full min-h-[100dvh] flex flex-col items-center overflow-x-hidden bg-background text-foreground p-4',
          className
        )}
        {...props}
      >
        ...
        {/* Content */}
        <div className="z-10 flex w-full flex-col items-center text-center space-y-8 md:space-y-12 my-auto">
          {/* Header Section */}
